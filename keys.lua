...
local function genkey(id, symbol, isModifier, description, geometry)
  ...
  if isModifier then
    key.bg = kbvwr.config.default_key_color
  else
    key.bg = kbvwr.config.modifier_key_color
  end
...
-- TODO: define XF86 keys

kbvwr.keys['Escape']    = genkey('Escape',    {"Esc", "Esc"},        false, { }, {w["Escape"],h["Fx"]} )
kbvwr.keys['F1']        = genkey('F1',        {"F1", "F1"},          false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F2']        = genkey('F2',        {"F2", "F2"},          false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F3']        = genkey('F3',        {"F3", "F3"},          false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F4']        = genkey('F4',        {"F4", "F4"},          false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F5']        = genkey('F5',        {"F5", "F5"},          false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F6']        = genkey('F6',        {"F6", "F6"},          false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F7']        = genkey('F7',        {"F7", "F7"},          false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F8']        = genkey('F8',        {"F8", "F8"},          false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F9']        = genkey('F9',        {"F9", "F9"},          false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F10']       = genkey('F10',       {"F10", "F10"},        false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F11']       = genkey('F11',       {"F11", "F11"},        false, { }, {w["Fx"],h["Fx"]}     )
kbvwr.keys['F12']       = genkey('F12',       {"F12", "F12"},        false, { }, {w["Fx"],h["Fx"]}     )
...
kbvwr.keys['[']         = genkey('[',         {"[", "["},            false, { }, {wd, hd} )
kbvwr.keys[']']         = genkey(']',         {"]", "]"},            false, { }, {wd, hd} )
kbvwr.keys['Return1']   = genkey('Return',    {"icon: ","icon: "}, false, { }, {w["Return1"], hd} )
kbvwr.keys['Caps_Lock'] = genkey('Caps_Lock', {"icon: ","icon: "}, false, { "not assigned" },       {w["Caps_Lock"], hd} )
...
kbvwr.keys['\'']        = genkey('\'',        {"'", "'"},            false, { }, {wd, hd} )
kbvwr.keys['\\']        = genkey('\\',        {"\\", "\\"},          false, { }, {wd, hd} )
kbvwr.keys['Return2']   = genkey('Return',    {"icon: ","icon: "}, false, { }, {w["Return2"], hd} )
kbvwr.keys['Shift_L']   = genkey('Shift',     {"icon: ","icon: "}, true , { }, {w["Shift_L"], hd} )
kbvwr.keys['<']         = genkey('<',         {"<", "<"},            false, { }, {wd, hd} )
...
kbvwr.keys['.']         = genkey('.',         {".", "."},            false, { }, {wd, hd} )
kbvwr.keys['/']         = genkey('/',         {"/", "/"},            false, { }, {wd, hd} )
kbvwr.keys['Shift_R']   = genkey('Shift',     {"icon: ","icon: "}, true , { }, {w["Shift_R"], hd} )
kbvwr.keys['Fn']        = genkey('Fn',        {"Fn", "Fn"},          true , { }, {w["Fn"], hd} )
kbvwr.keys['Control_L'] = genkey('Control_L', {"icon: ","icon: "}, true , { "CTRL left" },          {w["Control_L"], hd} )
kbvwr.keys['Super_L']   = genkey('Super_L',   {"icon: ","icon: "}, true , { "AwesomeWM commands" }, {w["Super_L"], hd} )
kbvwr.keys['Alt_L']     = genkey('Alt_L',     {"icon: ","icon: "}, true , { "Alt" },                {w["Alt_L"], hd} )
kbvwr.keys['space']     = genkey('Space',     {"icon: ","icon: "}, false, { }, {w["space"], hd} )
kbvwr.keys['Alt_R']     = genkey('Alt_R',     {"icon: ","icon: "}, true , { "Alt Gr" },             {w["Alt_R"], hd} )
kbvwr.keys['Print']     = genkey('Print',     {"icon: ","icon: "}, false, { }, {w["Print"], hd} )
kbvwr.keys['Control_R'] = genkey('Control_R', {"icon: ","icon: "}, true , { "CTRL right" },         {w["Control_R"], hd} )
