...
bindkey( { " ", " " }, 'Return',      "wibar",    "launch",  "toggle wibar visibility", global, function() wibars_toggle() end)
...
bindkey( { " ", " " },       'h',       " ﰂ ",           "layout", "increase number of clients", global, function() awful.tag.incnmaster(1, nil, true) end)
bindkey( { " ", " " },       'j',       " 吝 ",           "layout", "lower number of columns", global, function() awful.tag.incncol(-1, nil, true) end)
bindkey( { " ", " " },       'k',       " 溺 ",           "layout", "increase number of columns", global, function() awful.tag.incncol(1, nil, true) end)
bindkey( { " ", " " },       'l',       " ﯰ ",           "layout", "lower number of clients", global, function() awful.tag.incnmaster(-1, nil, true)  end)
...
bindkey( { " ", " " },       ' ',   "layout -",    "layout", "switch to previous layout", global, function () awful.layout.inc(-1) end)
bindkey( { " " },             ' ',   "layout +",    "layout", "switch to next layout", global, function () awful.layout.inc( 1) end)
bindkey( { " ", " " },       ' ',   "clear",       "awesome", "clear all notifications",    global,
        function() 
